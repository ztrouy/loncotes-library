...
public class LoncotesLibraryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Checkout {Id = 1, MaterialId = 3, PatronId = 2, CheckoutDate = new DateTime(2024, 01, 09), ReturnDate = new DateTime(2024, 01, 16)},
            new Checkout {Id = 2, MaterialId = 4, PatronId = 2, CheckoutDate = new DateTime(2024, 01, 22), ReturnDate = null},
            new Checkout {Id = 3, MaterialId = 5, PatronId = 2, CheckoutDate = new DateTime(2024, 01, 23), ReturnDate = new DateTime(2024, 02, 15)},
            new Checkout {Id = 4, MaterialId = 6, PatronId = 2, CheckoutDate = new DateTime(2024, 01, 26), ReturnDate = null},
            new Checkout {Id = 5, MaterialId = 7, PatronId = 2, CheckoutDate = new DateTime(2024, 02, 02), ReturnDate = new DateTime(2024, 02, 15)},
            new Checkout {Id = 6, MaterialId = 8, PatronId = 2, CheckoutDate = new DateTime(2024, 02, 15), ReturnDate = new DateTime(2024, 02, 23)},
            new Checkout {Id = 7, MaterialId = 9, PatronId = 2, CheckoutDate = new DateTime(2024, 02, 16), ReturnDate = new DateTime(2024, 02, 23)},
            new Checkout {Id = 8, MaterialId = 10, PatronId = 2, CheckoutDate = new DateTime(2024, 02, 23), ReturnDate = new DateTime(2024, 03, 04)},
            new Checkout {Id = 9, MaterialId = 13, PatronId = 2, CheckoutDate = new DateTime(2024, 03, 05), ReturnDate = new DateTime(2024, 03, 07)},
            new Checkout {Id = 10, MaterialId = 15, PatronId = 2, CheckoutDate = new DateTime(2024, 03, 13), ReturnDate = new DateTime(2024, 03, 18)},
            new Checkout {Id = 11, MaterialId = 2, PatronId = 1, CheckoutDate = new DateTime(2024, 01, 23), ReturnDate = new DateTime(2024, 02, 09)},
            new Checkout {Id = 12, MaterialId = 3, PatronId = 1, CheckoutDate = new DateTime(2024, 01, 26), ReturnDate = new DateTime(2024, 02, 09)},
            new Checkout {Id = 13, MaterialId = 7, PatronId = 1, CheckoutDate = new DateTime(2024, 02, 16), ReturnDate = new DateTime(2024, 03, 13)},
            new Checkout {Id = 14, MaterialId = 12, PatronId = 1, CheckoutDate = new DateTime(2024, 02, 17), ReturnDate = null},
            new Checkout {Id = 15, MaterialId = 13, PatronId = 1, CheckoutDate = new DateTime(2024, 03, 13), ReturnDate = new DateTime(2024, 03, 15)},
            new Checkout {Id = 16, MaterialId = 15, PatronId = 1, CheckoutDate = new DateTime(2024, 03, 29), ReturnDate = new DateTime(2024, 04, 01)},
            new Checkout {Id = 17, MaterialId = 2, PatronId = 3, CheckoutDate = new DateTime(2024, 02, 25), ReturnDate = new DateTime(2024, 03, 15)},
            new Checkout {Id = 18, MaterialId = 4, PatronId = 3, CheckoutDate = new DateTime(2024, 03, 28), ReturnDate = null},
            new Checkout {Id = 19, MaterialId = 12, PatronId = 3, CheckoutDate = new DateTime(2024, 04, 28), ReturnDate = null},
            new Checkout {Id = 20, MaterialId = 1, PatronId = 4, CheckoutDate = new DateTime(2024, 01, 23), ReturnDate = new DateTime(2024, 02, 04)},
            new Checkout {Id = 21, MaterialId = 3, PatronId = 4, CheckoutDate = new DateTime(2024, 02, 02), ReturnDate = null},
            new Checkout {Id = 22, MaterialId = 5, PatronId = 4, CheckoutDate = new DateTime(2024, 02, 05), ReturnDate = null},
            new Checkout {Id = 23, MaterialId = 1, PatronId = 5, CheckoutDate = new DateTime(2024, 04, 19), ReturnDate = null},
            new Checkout {Id = 24, MaterialId = 2, PatronId = 5, CheckoutDate = new DateTime(2024, 04, 19), ReturnDate = null},
